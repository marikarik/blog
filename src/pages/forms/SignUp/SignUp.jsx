        ...
        <h2 className={styles['form__header']}>Create new account</h2>
          <form className={styles['form']} onSubmit={handleSubmit(onSubmit)}>
            <label className={styles['form__label']}>Username
              <input className={`${styles['form__input']} ${errors?.username || serverError?.username ? styles['login-form__input-error'] : ''}`} placeholder='Username'
            ...
            <label className={styles['form__label']}>Email address
               <input className={`${styles['form__input']} ${errors?.email || serverError?.email ? styles['login-form__input-error'] : ''}`} placeholder='Email address'
