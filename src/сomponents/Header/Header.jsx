...
export default function Header() {
  ...
  const { data, isSuccess } = useGetUserInfoQuery(token, { skip: !token })
    ...
    <header className={`${styles.header}`}>
      ...
      {!isLogged ? (
        <>
          ...
          <Link
            to="/sign-up"
            className={`${styles.header__link_signup} ${styles.header__button_create}`}
          >
            Sign Up
          </Link>
        </>
        ...
        <>
          <Link
            to="/create-article"
            className={`${styles.header__link_createArticle} ${styles.header__button_create}`}
          >
            Create article
          </Link>
          ...
          <button className={styles['header__button-logout']} onClick={handleLogOut}>
            Log Out
          </button>
        </>
      )}
